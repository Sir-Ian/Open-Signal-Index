...
// .wrangler/tmp/bundle-5PTp5e/checked-fetch.js
...
// .wrangler/tmp/bundle-5PTp5e/strip-cf-connecting-ip-header.js
...
var WsStream = class extends Stream {
  ...
  static open(client) {
    ...
    const errorCallback = /* @__PURE__ */ __name((e2) => stream.#setClosed(e2), "errorCallback");
  ...
  #flushQueue() {
    for (; ; ) {
      ...
      if (entry === void 0 && this.#cursor === void 0 && this.#closing) {
        ...
        const responseCallback = /* @__PURE__ */ __name(() => void 0, "responseCallback");
        const errorCallback = /* @__PURE__ */ __name((e2) => cursor._setClosed(e2), "errorCallback");
        this.#client._sendRequest(request, { responseCallback, errorCallback });
        this.#cursor = cursor;
...
var WsClient = class extends Client {
  ...
  storeSql(sql) {
    ...
    const responseCallback = /* @__PURE__ */ __name(() => void 0, "responseCallback");
    const errorCallback = /* @__PURE__ */ __name((e2) => sqlObj._setClosed(e2), "errorCallback");
  ...
  _closeSql(sqlId) {
    ...
    const errorCallback = /* @__PURE__ */ __name((e2) => this.#setClosed(e2), "errorCallback");
...
function toLocalDay(isoDate, timeZone) {
...
async function fetchSearchPosts(session) {
...
__name(fetchSearchPosts, "fetchSearchPosts");
async function fetchAuthorFeed(session, actor) {
  const params = new URLSearchParams({
    limit: "30",
    actor
  });
...
__name(fetchAuthorFeed, "fetchAuthorFeed");
async function ingestBluesky(env, client) {
  ...
  const posts = [];
  const uniqueByUri = /* @__PURE__ */ new Map();
...
__name(ingestBluesky, "ingestBluesky");
...
router.get("/api/daily", async (_req, env) => {
  const client = await getClient(env);
  await ensureSchema(client);
  const { rows } = await client.execute({
...
router.get("/api/trends", async () => {
  ...
  const mock = Array.from({ length: 7 }).map((_, idx) => ({
    date: new Date(now.getTime() - idx * 864e5).toISOString().slice(0, 10),
...
// .wrangler/tmp/bundle-5PTp5e/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-5PTp5e/middleware-loader.entry.ts
